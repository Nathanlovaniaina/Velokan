            ...
            <div class="sidebar-content js-simplebar">
                ...
                <ul class="sidebar-nav">
                    ...
                    <li class="sidebar-item active">
                        <a class="sidebar-link" href="${pageContext.request.contextPath}/plats/creer_plat">
                            <span class="align-middle">Créer un plat</span>
                        </a>
                    </li>
                    <li class="sidebar-item">
                        <a class="sidebar-link" href="${pageContext.request.contextPath}/plats/liste">
                            <span class="align-middle">Liste des plats</span>
                        </a>
                    </li>
                </ul>
            </div>
