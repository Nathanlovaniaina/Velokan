        ...
        <nav id="sidebar" class="sidebar js-sidebar">
            <div class="sidebar-content js-simplebar">
                ...
                <ul class="sidebar-nav">
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link" href="${pageContext.request.contextPath}/entreprise/list">
                            <i class="bi bi-building align-middle me-2"></i>
                            <span class="align-middle">Gestion des entreprises</span>
                        </a>
                    </li>
                    <li class="sidebar-item active">
                        <a class="sidebar-link" href="${pageContext.request.contextPath}/mvtcontrat/list">
                            <i class="bi bi-file-earmark-text align-middle me-2"></i>
                            <span class="align-middle">Mouvements de contrat</span>
                        </a>
                    </li>
                </ul>
            </div>
